...
The evaluation compares proposed metrics against established industry baselines.
...
\begin{itemize}
    ...
    \item \textbf{SAST Comparison:} Run the AI-generated codebases through traditional SAST tools (CodeQL, SonarQube) and compare against AI-powered multi-agent systems (like IRIS) to measure detection improvements and false-positive reduction.
\end{itemize}

\subsection{Baseline Benchmarking (Human vs.\ AI)}
\begin{itemize}
    \item \textbf{Historical Codebase Evolution:} Compare post-2022 AI-assisted repository data against pre-2021 human-authored baselines, specifically the ratio of duplicated/copy-pasted code blocks against refactored code.
